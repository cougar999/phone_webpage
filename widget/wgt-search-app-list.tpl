<!--{feed int=AP_INT_SEARCHLIST keyword=$keyword order=$smarty.get.order|default:0 pageno=$smarty.get.pageno|default:1 num=18 ret='applistnew'}-->
<div class="section">
...
<div class="section" id="softlist">
	<!--{foreach key=key item=item from=$applistnew.data name="catelisteach"}-->
	<dl>
		<dt>
			<ul>
