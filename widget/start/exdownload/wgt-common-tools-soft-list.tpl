...
<!--{if $key == 0}-->
	<!--{feed int=AP_INT_MENU_CAT_SOFTLIST2 mid=$category.menuid order=0 pageno=$smarty.request.pageno|default:1 count=48 iscrack=$smarty.request.iscrack|default:0 ret='colomunlist'}-->
	<!--{if $colomunlist.page.items}-->
	<!--{foreach key=key_list item=item from=$colomunlist.page.items}-->
	<dl class="softa">
