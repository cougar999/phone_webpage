 ...
 * 
 * CVS FILE $Id: show_detailed.php 2952 2011-10-07 06:53:48Z zhoufei $
 *  
...
function bbc_show_connect_field($connect, $field, $lng, $titles = false) {
  ...
  switch ($field) {
    ...
    case "ext":
      $lable = $extensions[$connect['ext']];
      return "<div align=\"left\">&nbsp;<img src=\"".$BBC_IMAGES_PATH."ext/".$connect['ext'].".png\" class=\"icon\" alt=\"".$lable."\" title=\"".$lable."\" />&nbsp;&nbsp;".$lable."</div>";
