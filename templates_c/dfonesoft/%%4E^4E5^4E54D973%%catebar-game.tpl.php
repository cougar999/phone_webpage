<?php /* Smarty version 2.6.26, created on 2014-02-17 21:51:22
         compiled from dxsoft/catebar-game.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'feed', 'dxsoft/catebar-game.tpl', 3, false),array('modifier', 'default', 'dxsoft/catebar-game.tpl', 6, false),)), $this); ?>
<h2>游戏</h2>
<ul>
	<?php echo smarty_function_feed(array('int' => 'AP_INT_GETALLCATE','sort' => 'Game','ret' => 'catelist'), $this);?>
...
&sort=Game"><?php echo ((is_array($_tmp=@$this->_tpl_vars['item']['name'])) ? $this->_run_mod_handler('default', true, $_tmp, "未知应用") : smarty_modifier_default($_tmp, "未知应用")); ?>
</a></li>
	<?php endif; ?>
