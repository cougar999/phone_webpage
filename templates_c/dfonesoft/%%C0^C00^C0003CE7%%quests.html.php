<?php /* Smarty version 2.6.26, created on 2014-02-24 22:20:08
         compiled from intergral/quests.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'intergral/quests.html', 1, false),array('function', 'feed', 'intergral/quests.html', 94, false),)), $this); ?>
...
<?php echo smarty_function_feed(array('int' => 'AP_INT_GET_COIN_SCALE','ret' => 'scaleurl'), $this);?>


<script language="JavaScript">
function getTaskList(row){
	$('.tasklist_content').html('<center><img src="<?php echo $this->_config[0]['vars']['img1']; ?>
