<?php /* Smarty version 2.6.26, created on 2014-02-17 21:51:25
         compiled from layout_appstore.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'layout_appstore.html', 1, false),array('modifier', 'date_format', 'layout_appstore.html', 6, false),)), $this); ?>
...
<link href="<?php echo $this->_config[0]['vars']['res6']; ?>
/resources/lib/jquery.autocomplete/jquery.autocomplete.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo $this->_config[0]['vars']['res5']; ?>
/resources/js<?php echo $this->_config[0]['vars']['version']; ?>
/shopcollection.js"></script>
<script type="text/javascript" src="<?php echo $this->_config[0]['vars']['res1']; ?>
/resources/js<?php echo $this->_config[0]['vars']['version']; ?>
/jquery.slideimg.js"></script>
<script type="text/javascript" src="<?php echo $this->_config[0]['vars']['res6']; ?>
/resources/lib/jquery.autocomplete/jquery.autocomplete20121017.js"></script>
<script type="text/javascript" src="<?php echo $this->_config[0]['vars']['res2']; ?>
/resources/js<?php echo $this->_config[0]['vars']['version']; ?>
/app.js"></script>
...
<div class="page"><div class="wrap">
	<div class="body"><div class="wrap">
		...
		<div class="container"><div class="wrap">
			...
			<!-- center start -->
			<div class="center" style="margin-left:0px;"><div class="warp">
