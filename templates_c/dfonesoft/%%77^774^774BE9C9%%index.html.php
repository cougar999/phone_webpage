...
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'index.html', 1, false),array('function', 'params', 'index.html', 78, false),array('modifier', 'date_format', 'index.html', 6, false),array('modifier', 'default', 'index.html', 78, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
					<?php elseif ($this->_tpl_vars['tp_tpl_page_plugin'] == 'mobile.php'): ?>
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "menu/mobile/menu_mobile.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
unset($_smarty_tpl_vars);
 ?>
			...
			<div class="center"><div class="wrap">
				<?php if (( $_GET['channelcode'] && $_GET['channelcode'] != '1100000' ) && ( $_GET['phonetype'] == '.' || $_GET['phonetype'] == '' || $_GET['phonetype'] == 3 || $_GET['phonetype'] == '3.' )): ?><!--用来判断是不是乐语渠道的页面-->
					<iframe name="pagecontainer" id="pagecontainer" src="/appstore/download.html" frameborder="0" height="100%" width="100%"></iframe>
				<?php else: ?>
					<iframe name="pagecontainer" id="pagecontainer" src="<?php echo ((is_array($_tmp=@$_GET['gotopage'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['page']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['page'])); ?>
?<?php echo smarty_function_params(array('phonetype' => ((is_array($_tmp=@$_GET['phonetype'])) ? $this->_run_mod_handler('default', true, $_tmp, '0') : smarty_modifier_default($_tmp, '0')),'iscrack' => ((is_array($_tmp=@$_GET['iscrack'])) ? $this->_run_mod_handler('default', true, $_tmp, '0') : smarty_modifier_default($_tmp, '0')),'channelcode' => ((is_array($_tmp=@$_GET['channelcode'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')),'gotopage' => null), $this);?>
