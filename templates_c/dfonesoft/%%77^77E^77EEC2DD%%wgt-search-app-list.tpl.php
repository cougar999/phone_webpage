<?php /* Smarty version 2.6.26, created on 2014-03-10 22:56:26
         compiled from wgt-search-app-list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'feed', 'wgt-search-app-list.tpl', 1, false),array('modifier', 'default', 'wgt-search-app-list.tpl', 1, false),array('modifier', 'strip_tags', 'wgt-search-app-list.tpl', 18, false),array('modifier', 'truncate_utf8_string', 'wgt-search-app-list.tpl', 18, false),array('modifier', 'sizetext', 'wgt-search-app-list.tpl', 19, false),)), $this); ?>
<?php echo smarty_function_feed(array('int' => 'AP_INT_SEARCHLIST','keyword' => $this->_tpl_vars['keyword'],'order' => ((is_array($_tmp=@$_GET['order'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)),'pageno' => ((is_array($_tmp=@$_GET['pageno'])) ? $this->_run_mod_handler('default', true, $_tmp, 1) : smarty_modifier_default($_tmp, 1)),'num' => 18,'ret' => 'applistnewA'), $this);?>

<div class="section">
	<div style="padding: 15px 15px;">
		<div style="border: 1px solid #d2d2d2; padding: 8px 8px;" class="f4 b">
			在<font color="#f04e06"><?php echo $this->_tpl_vars['assign']['ap_int']['AP_INT_SEARCH_TYPE_NAME_APP']; ?>
</font>中搜索“<?php echo $_REQUEST['keyword']; ?>
”共有<?php echo ((is_array($_tmp=@$this->_tpl_vars['applistnew']['totalNum'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)); ?>
条结果：
		</div>
	</div>
</div>
<div class="section" id="softlist">
	<?php $_from = $this->_tpl_vars['applistnewA']['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['catelisteach'] = array('total' => count($_from), 'iteration' => 0);
...
<?php else: ?>0MB<?php endif; ?></li>
				<li><div class="down f_l"><a id="<?php echo ((is_array($_tmp=@$this->_tpl_vars['item']['fileId'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)); ?>
" businesstype="1" isbiz="0" href="<?php echo $this->_tpl_vars['item']['path']; ?>
...
" type="1" goldcoins="1" class="change <?php if ($this->_tpl_vars['item']['black'] && $this->_tpl_vars['item']['black'] == 1): ?>downdisable<?php else: ?>downinit<?php endif; ?> newpage"  onclick="return false;"></a></div></li>
			</ul>
		</dt>
